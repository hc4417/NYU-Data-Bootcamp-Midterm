...
Moreover, we concluded from **3.2** that this product price range has some flexibility, as local luxury boutiques often have products in an extensive range, likely allowing them to slightly broaden their range of customer demographics. 
